...
**Wrong CNAME target:** Setting `app.helm.mom` to a `reins-*.fly.dev` agent machine URL instead of `agenthelm-core.fly.dev`. This causes the OpenClaw console UI to be served instead of the AgentHelm dashboard.
